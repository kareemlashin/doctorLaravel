                    ...
                    <div class="single-box">
                        ...
                        <div class="my-2 mx-4">
                            ...
                            <h3 class="pt-3 mx-3 clearfix">table Of Service
                                <a class="btn btn-rounded theme-btn-one px-3 py-1  float-right" href="{{route('tableAllService')}}">table Service</a>
                            </h3>
                        </div>
                        @csrf
                        <div class="row mx-3">
                            ...
                            <div class="col-lg-6 col-md-6  form-group">
                                ...
                                <input type="text" name="name_ar" value="{{$service->name_ar}}" placeholder="name arabic">
                                <div>
                            ...
                            <div class="col-lg-6 col-md-6  form-group">
                                ...
                                <input type="text" name="name_en" value="{{$service->name_en}}" placeholder="name english">
                                <div>
                            ...
                            <div class="col-lg-6 col-md-6  form-group">
                                <label>price</label>
                                <input type="number" name="price" value="{{$service->price}}" placeholder="price">
                                <div>
                            ...
                            <div class="col-lg-6 col-md-6  form-group">
                                ...
                                <input type="text" name="description_en" value="{{$service->description_en}}" placeholder="description">
                                <div>
                            ...
                            <div class="col-lg-6 col-md-6  form-group">
                                ...
                                <input type="text" name="description_ar" value="{{$service->description_ar}}" placeholder="description">
                                <div>
