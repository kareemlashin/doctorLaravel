            ...
            <div class="outer-container">
                ...
                <form class="add-listing my-profile" method="POST" id="edit_user" enctype="multipart/form-data">
                    ...
                    <div class="single-box">
                        ...
                        <div id="success"></div>
                        <div class="my-2 mx-4">
                            <h3 class="clearfix">Add offer
                                <a class="btn btn-rounded theme-btn-one px-3 py-1 my-2 float-right" href="{{route('tableAllOffers')}}">table of offer</a>
