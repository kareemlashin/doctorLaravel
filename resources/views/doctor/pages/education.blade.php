                    ...
                    <div class="single-box">
                        ...
                        <div class="my-2 mx-4">
                            <h3 class="pt-3 mx-3 clearfix">
                                Add education
                                <a class="btn btn-rounded theme-btn-one px-3 py-1  float-right" href="{{route('tableAllEducation')}}">table education</a>
                        ...
                        <div class="row mx-3">
                            ...
                            <div class="col-lg-6 col-md-6  form-group">
                                <label>name arabic education</label>
                            ...
                            <div class="col-lg-6 col-md-6  form-group">
                                <label>name english education</label>
                            ...
                            <div class="col-lg-6 col-md-6  form-group">
                                ...
                                <input type="number" name="presente" placeholder="presente">
                                <div>
                                    <div class="error error-presente"></div>
