                ...
                <form class="add-listing my-profile" method="POST" id="edit_user" enctype="multipart/form-data">
                    ...
                    <div class="single-box">
                        ...
                        <div class="checkbox-buttons-container mx-3">
                            ...
                            <input type="checkbox" id="{{$specialties->specialties_en}}" value="{{$specialties->id}}"
                                   @foreach($specDoc as $specDo)
                                   {{ $specDo->specialties_id==$specialties->id ? 'checked':''}}
                                       @endforeach
                                   name="specialties_id[]">
                            <label for="{{$specialties->specialties_en}}">{{$specialties->specialties_en}}
                                <img src="{{asset($specialties->photo)}}" width="25px" height="25px" alt=""
                                     srcset=""> </label>
                                </span>
                            @endforeach
                        </div>
                        <div class="error error-specialties_id"></div>
                ...
                $.ajax(
                    {
                        ...
                        url: "{{ route('specialtiesDoctorAdd') }}",
                        data: inputData,
