            ...
            <div class="outer-container">
                ...
                <form class="add-listing my-profile" method="POST" id="edit_user" enctype="multipart/form-data">
                    ...
                    <div class="single-box">
                        ...
                        <div id="success"></div>
                        <div class="my-2 mx-4 text-right">
                            <a class="btn btn-rounded theme-btn-one px-3 py-1 my-2 " href="{{route('tableAllOffers')}}">table of offer</a>
                        </div>
                        @csrf
                        <div class="row mx-3">
                            ...
                            <div class="col-lg-6 col-md-6  form-group">
                                ...
                                <input type="text" name="name_ar" value="{{$offers->name_ar}}"
                            ...
                            <div class="col-lg-6 col-md-6  form-group">
                                ...
                                <input type="text" name="name_en" value="{{$offers->name_en}}"
                            ...
                            <div class="col-lg-6 col-md-6  form-group">
                                <label>price</label>
                                <input type="number" value="{{$offers->price}}" name="price" placeholder="price">
                                <div>
                            ...
                            <div class="col-lg-6 col-md-6  form-group">
                                ...
                                <input type="text" name="description_en" value="{{$offers->description_en}}"
                            ...
                            <div class="col-lg-6 col-md-6  form-group">
                                ...
                                <input type="text" name="description_ar" value="{{$offers->description_ar}}"
                                       placeholder="description">
                                <div>
