    ...
    <div class="bg-white rounded p-5 position-relative clearfix my-5">
        ...
        <form method="POST" id="edit_user" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="specialties_ar">specialties araic</label>
                <input type="text" class="form-control" id="specialties_ar" name="specialties_ar"
                       placeholder="Enter gender arabic">
            </div>
            <div id="error-specialties_ar" class="error"></div>

            <div class="form-group">
                <label for="gender_ar">specialties english</label>
                <input type="text" class="form-control" id="specialties_en" name="specialties_en"
                       placeholder="Enter gender english">
            </div>
            <div id="error-specialties_en" class="error"></div>
