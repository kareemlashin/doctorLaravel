...
@section('content')
                ...
                <form class="add-listing my-profile" method="POST" id="edit_user" enctype="multipart/form-data">
                    ...
                    <div class="single-box">
                        ...
                        <div id="success"></div>
                        <div class="my-2 mx-4">
                            <h3 class="clearfix">Add syndromes
                                <a class="btn btn-rounded theme-btn-one px-3 py-1 my-2 float-right" href="{{route('tableSyndromes')}}">table of Syndromes</a>
                            </h3>
                        </div>
                        @csrf
                        <div class="row mx-3">
