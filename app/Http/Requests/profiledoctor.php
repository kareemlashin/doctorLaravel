...
class profiledoctor extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'linkediin' => 'nullable|max:255|url',
            'twitter' => 'max:255|url|nullable',
            'insgram' => 'max:255|url|nullable',
            'facebook' => 'max:255|url|nullable',
            'text' => 'required|string|min:50|max:255',
            ...
            'header' => 'nullable|image|mimes:jpg,jpeg,png',
    ...
    public function messages()
    {
        return [
            ...
            'price.between' => 'price max between 10 to up',

            'text.required' => 'description required ',
            'text.string' => ' description string',
            'text.max' => 'description max 255',
            'text.min' => 'description min 2',
            ...
            'website.max' => 'website max 255 ',
            'website.url' => 'website url',

            'linkediin.max' => 'linkediin max 255 ',
            'linkediin.url' => 'linkediin url',

            'twitter.max' => 'website max 255 ',
            'twitter.url' => 'website url',

            'insgram.max' => 'insgram max 255 ',
            'insgram.url' => 'insgram url',

            'facebook.max' => 'facebook max 255 ',
            ...
            'header.image' => 'must be  image',
            'header.mimes' => 'image must be jpg,jpeg,png',
